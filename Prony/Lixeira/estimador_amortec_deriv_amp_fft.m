...
function [amort_final] = estimador_amortec_deriv_amp_fft(Sa, Sb, Sc, f0, Fs, ref_seg, m)
...
for i=1:num_wins-1;
    ...
    desvio_amp(1,i) = (abs(fasor_012(1,i+1)) - abs(fasor_012(1,i)))*2/win_size;
    desvio_amp(2,i) = (abs(fasor_012(2,i+1)) - abs(fasor_012(2,i)))*2/win_size;
    desvio_amp(3,i) = (abs(fasor_012(3,i+1)) - abs(fasor_012(3,i)))*2/win_size;
