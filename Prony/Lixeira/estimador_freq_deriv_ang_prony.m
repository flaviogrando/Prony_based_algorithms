...
function [freq_final] = estimador_freq_deriv_ang_prony(Ha, Hb, Hc, f0, Fs, ref_seg, m)

[num_wins,win_size] = size(Ha');
...
% Seleção automática da componente fundamental (PARA DFT)
...
% Obs.: Depende da entrada de dados, pode mudar conforme o método
fasor_abc(1,:) = Ha(1,:);
fasor_abc(2,:) = Hb(1,:);
fasor_abc(3,:) = Hc(1,:);
